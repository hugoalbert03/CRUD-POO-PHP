...
<body>
    ...
    <main>
        ...
        <form action="cadastro.php" method="post">  
            <p>
                <label for="nome">Nome: </label><input type="text" value="
                <?php 
                    echo in_array($conteudo,)
                
                ?>
                " name="nome" maxlength="100" id="nome" required>
            </p><p>
                <label for="matricula">Matricula: </label><input type="number" value="<?php ?>" min="1000" max="9999" name="matricula" id="matricula" required>
            </p><p>
                <label for="turma">Turma: </label><input type="text" value="<?php ?>" name="turma" maxlength="30" id="turma" required>
            </p><p>
                <label>Turno</label>
                <select name="turno" value="<?php ?>">
